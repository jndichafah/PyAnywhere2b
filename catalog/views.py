...
def author_delete(request, pk):
    ...
    try:
        ...
        messages.success(request, (
                author.first_name + ' ' + author.last_name + ' cannot be deleted. No Copies Available'))
...
class BookCreate(CreateView):
    model = Book
    fields = ['book_title', 'isbn', 'book_image']
...
def book_delete(request, pk):
    ...
    try:
        ...
        messages.success(request, (
                book.title + ' cannot be deleted. No Copies Available'))
